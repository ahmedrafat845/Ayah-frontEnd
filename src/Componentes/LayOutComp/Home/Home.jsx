          ...
          <div className="row">
            <div className="col-12 col-md-8  m-auto text-center  ">
              <div className={`${style.captionHome}`}>
                ...
                <p>
                  يتيح لك موقع آية مجموعة من الأدوات والموارد لتعزيز عبادتك
                  اليومية، مثل الأذكار اليومية للصباح والمساء، والأحاديث
                  النبوية، والرقية الشرعية، بالإضافة إلى سبحة إلكترونية تساعدك
                  على التسبيح والاستغفار في أي وقت. كما يحتوي الموقع على قسم خاص
                  بالدعاء يضم عدة أقسام مثل أدعية القرآن، وأدعية الرزق، وأدعية
                  يوم عرفة وغيرها، لتسهيل الوصول إلى الأدعية المناسبة لكل وقت.
                </p>
